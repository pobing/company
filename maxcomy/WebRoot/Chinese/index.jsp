...
<script type="text/javascript" src="<%=basePath %>js/today.js"></script>
	...
	<div id="header">
        ...
        <div id="logoandcontent">
            ...
            <div id="headcontent">
            	<div class="language">
                    <ul>
                    	<li class="height"><a href="index.html">Chinese</a></li>
       ...
       +today.getDate()+"日"+"&nbsp;&nbsp;"+isnDays[today.getDay()]);
                ...
                <div class="nav">
                	<ul>
                    	...
                    	<li><a href="swtd.jsp" target="page">团队力量</a></li>
                      ...
                      <li><a href="xwjs.jsp" target="page">新闻纪事</a></li>
                        <li><a href="dxal.jsp" target="page">典型案例</a></li>
                         <li><a href="ptjs.jsp" target="page">产品服务</a></li>
                            <li><a href="dljm.jsp" target="page">代理加盟</a></li>
...
<div class="lastnav">
        	<div class="lastnavul">
            	<ul class="display_none">
                  ...
                  <ul class="display_none">
                	...
                	<li class="lastnavheight"><a target="page" href="swtd.jsp" >组织机构图</a></li>
                </ul>
                <ul>
                	<li><a href="fzjg.jsp" target="page">分支结构</a></li>
                	<li><a href="hzhb.jsp" target="page">合作伙伴</a></li>
                ...
                <ul class="display_none" style="padding-right:240px;">
                  <li><a href="cpfw.jsp" target="page">产品服务</a></li>
                    <li><a href="zzcp.jsp" target="page">终端产品</a></li>
                    <li class="lastnavheight"><a target="page" href="ptjs.jsp">平台介绍</a></li>
                </ul>
                <ul class="display_none">
                	<li></li>
                </ul>
	...
	<iframe id="heightname" name="page" frameborder="0"  height="490px" scrolling="no" width="100%" src="produce.jsp"  onload="SetCwinHeight(this);"></iframe>
